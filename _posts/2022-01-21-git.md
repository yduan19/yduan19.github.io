...
| Description | Command |
| ------- | ----------- |
| Merge into a single commit|`git merge --squash source-branch"`|
| Pull and maintain a linear commit history.|`git pull --rebase`|
| Abort rebase if encounter conflicts|`git rebase abort`|
